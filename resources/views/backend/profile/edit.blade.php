            ...
            <div style="display: flex; gap: 40px; align-items: flex-start;">
                ...
                <div style="width: 320px; height: 420px; border: 1.5px solid #a6a6a6; background-color: #fff; display: flex; align-items: center; justify-content: center;">
                    <div style="width: 120px; height: 120px; background-color: #000; color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 48px; font-weight: bold;">
                        <?= e(strtoupper(substr($user->nama_admin ?? $user->name ?? 'A', 0, 1))) ?>
                    </div>
                </div>
                ...
                <div style="flex: 1; max-width: 650px;">
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <input type="text" value="<?= e($user->role ?? 'Admin') ?>" style="width: 100%; padding: 10px; border: 1.5px solid black; background-color: #fff; font-size: 14px;" readonly>
                    </div>

                    <div style="margin-bottom: 20px;">
                        <label style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 14px;">Status :</label>
                        <input type="text" value="<?= e($user->status ?? 'Aktif') ?>" style="width: 100%; padding: 10px; border: 1.5px solid black; background-color: #fff; font-size: 14px;" readonly>
                    </div>

                    <div style="margin-bottom: 20px;">
                        <label style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 14px;">Nama :</label>
                        <input type="text" name="nama_admin" value="<?= e(old('nama_admin', $user->nama_admin ?? $user->name)) ?>" style="width: 100%; padding: 10px; border: 1.5px solid black; font-size: 14px;" required>
                        @error('nama_admin') <small style="color: red;"><?= e($message) ?></small> @enderror
                    </div>

                    <div style="margin-bottom: 20px;">
                        <label style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 14px;">Email :</label>
                        <input type="email" name="email" value="<?= e(old('email', $user->email)) ?>" style="width: 100%; padding: 10px; border: 1.5px solid black; font-size: 14px;" required>
                        @error('email') <small style="color: red;"><?= e($message) ?></small> @enderror
                    </div>

                    <div style="margin-bottom: 20px;">
                        <label style="display: block; font-weight: bold; margin-bottom: 5px; font-size: 14px;">No hp :</label>
                        <input type="text" name="no_hp" value="<?= e(old('no_hp', $user->no_hp ?? '')) ?>" style="width: 100%; padding: 10px; border: 1.5px solid black; font-size: 14px;">
                        @error('no_hp') <small style="color: red;"><?= e($message) ?></small> @enderror
                    </div>
                    ...
                    <div style="margin-bottom: 35px;">
                        ...
                        @error('password') <small style="color: red;"><?= e($message) ?></small> @enderror
                    </div>
                    ...
                    <a href="<?= route('backend.dashboard') ?>" style="background-color: #000; color: #fff; text-decoration: none; padding: 12px 40px; font-weight: bold; font-size: 16px; display: inline-flex; align-items: center; gap: 8px; text-align: center;">
